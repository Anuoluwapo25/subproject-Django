...
def index(request):
    return render(request, 'learning_paths/index.html')

def questions(request):
    return render(request, 'learning_paths/questions.html')
...
#         }
#         return render(request, 'learning_paths/results.html', context)
#     return render(request, 'learning_paths/questions.html')
